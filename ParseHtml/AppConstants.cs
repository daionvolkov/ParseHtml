...
{
    public const string token = "61-3cbddbd7-0bdb-437b-9144-0cdbfc3d147b";
    public const int userId = 61;
    public const string title = "Музыка иврита";
    public const int targetLanguageId = 3;
    public const int writtenLanguageId = 2;
    ...
    public const int HttpTimeoutInSeconds = 130;
}
